...
class AddDaylightSensorstoControlLightinginPerimeterZones_Test < Test::Unit::TestCase
  def test_AddDaylightSensorstoControlLightinginPerimeterZones

    # create an instance of the measure
    measure = AddDaylightSensorstoControlLightinginPerimeterZones.new
